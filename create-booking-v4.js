async function createBooking() {
  try {
    ...
    // Tạo thời gian bắt đầu và kết thúc cho ngày mai (10:00-11:00) - sử dụng local time
    const startTime = `${dateString}T10:00:00`;
    const endTime = `${dateString}T11:00:00`;
    ...
    console.log('- Thời gian: 10:00 - 11:00');
    console.log('');
